...
export default class TopLosers extends Component {
  ...
  fetchStocks() {
    Axios.get('https://www1.nseindia.com/live_market/dynaContent/live_analysis/losers/niftyLosers1.json').then(res => {
   ...
   dumpComma(com){
     ...
     {       
        ...
        com.data[i].highPrice = (com.data[i].highPrice + "").replace(',', '')
   ...
   render(){
    ...
    return(
      <React.Fragment>
        ...
        <Grid item md={10}>
        <Widget
            title={<Typography variant="h3" component="h2" gutterBottom='true'>Top Losers</Typography>}>
        <HorizontalBar
